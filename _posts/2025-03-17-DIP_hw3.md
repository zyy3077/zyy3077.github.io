...
Given 4 original-damaged image pairs, we need to designed a method to remove the Red Text on the damaged ones, in an effort to get closed to the original at most. Specific implementation is available at: [github-repo](https://github.com/zyy3077/Digital-Image-Process-PKU-2025spring.git.)
